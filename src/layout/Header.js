  ...
  <header className="main-header">
    ...
    <div className="header-upper">
      <div className="container-fluid clearfix">
        <div className="header-inner d-flex align-items-center px-5">
          ...
          <div className="menu-icons">
            ...
            <Link href="/contact">
              ...
              Call Us <i className="fas fa-angle-double-right" />
              </a>
            </Link>
            {/* menu sidbar */}
...
const Header1 = () => (
  <header className="main-header menu-absolute">
    ...
    <div className="header-upper">
      <div className="container-fluid clearfix">
        <div className="header-inner d-grid align-items-center main-header">
          <div className="logo-outer">
            <div className="logo">
              <Link href="/">
                <a>
